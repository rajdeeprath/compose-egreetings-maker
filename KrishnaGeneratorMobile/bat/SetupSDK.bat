...
:: Path to Flex SDK
set FLEX_SDK=H:\Program Files\FlashDevelop\Tools\flexsdk3.9
::C:\Program Files\Adobe\Adobe Flash Builder 4.6\sdks\flex_sdk_4.6_air3.5_fp11.5

:: Path to Android SDK
set ANDROID_SDK=H:\Program Files\FlashDevelop\Tools\android
